...
"multipart/form-data"):jQuery(d).attr("enctype","multipart/form-data"),jQuery(d).submit()}catch(h){jQuery.handleError(b,f,null,h)}jQuery("#"+c).load(e);return{abort:function(){}}},uploadHttpData:function(b,a){var d;d="xml"==a||!a?b.responseXML:b.responseText;"script"==a&&jQuery.globalEval(d);"json"==a&&eval("data = "+d);"html"==a&&jQuery("<div>").html(d).evalScripts();return d}});var IN_SAE=!1,SERVER_URL=IN_SAE?"http://ahutlesson.sinaapp.com":"http://localhost/lesson/";function apiGet(b,a){$.getJSON(b,function(b){1==b.code?alert(b.msg):0==b.code&&("undefined"!=typeof b.data?"undefined"!=typeof b.metadata?a(b.data,b.metadata):a(b.data):a())})}function apiPost(b,a,d){$.post(b,a,function(a){1==a.code?alert(a.msg):0==a.code&&("undefined"!=typeof a.data?"undefined"!=typeof a.metadata?d(a.data,a.metadata):d(a.data):d())},"json")}
function apiPost(b,a,d,c){$.post(b,a,function(a){1==a.code?(alert(a.msg),c()):0==a.code&&("undefined"!=typeof a.data?"undefined"!=typeof a.metadata?d(a.data,a.metadata):d(a.data):d())},"json")}function getAvatarURL(b,a){return a?IN_SAE?"http://ahutlesson-upload.stor.sinaapp.com/avatar/"+b+".jpg":"http://localhost/lesson/upload/avatar/"+b+".jpg":"static/img/noavatar.jpg"}function toggleSaveCookie(){var b=$("#save_cookie");b.attr("checked",!b.attr("checked"))}
function login(){var b=$("#login_xh").val(),a=$("#login_password").val(),d=$("#save_cookie").attr("checked");apiPost("api/user.handler.php?act=login",{x:b,p:a},function(a){d?$.cookie("ck",a,{expires:30}):$.cookie("ck",a);window.location.reload()})}function loginOut(){$.removeCookie("ck");window.location.reload()}function atToday(b){var a=new Date;return b.getFullYear()==a.getFullYear()&&b.getMonth()==a.getMonth()&&b.getDate()==a.getDate()}
function atThisYear(b){var a=new Date;return b.getFullYear()==a.getFullYear()}function strtotime(b){var a=b.split(" ");b=a[1];a=a[0].split("-");b=b.split(":");return new Date(a[0]-0,a[1]-0-1,a[2]-0,b[0]-0,b[1]-0,b[2]-0)}var origin_title="",logged_uxh="",unreadMessageCount=0,unreadNoticeCount=0;function isInt(b){return 0==b%1}
function checkUnreadMessage(){apiGet("api/notice.handler.php?act=getunreadcount&uxh="+logged_uxh,function(b){unreadMessageCount=b.m;unreadNoticeCount=b.n;refreshUnreadCount()})}
...
function sendpm(){var b=sendpm_uxh,a=$("#pm_title").val(),d=$("#pm_content").val();""==a.length||""==d.length?alert("\u6807\u9898\u6216\u5185\u5bb9\u4e3a\u7a7a\uff01"):apiPost("api/notice.handler.php?act=sendmessage",{u:b,t:a,c:d},function(){$("#pm_title").val("");$("#pm_content").val("");$(".pmdiv").fadeOut(500)})}$.ajaxSetup({cache:!1});function loadForumPage(b){apiGet("api/getforum.php?page="+b,function(a,d){totalThreads=d.total;threadsPerPage=d.threadsPerPage;currentPage=b;showForum(a)})}
...
d+"</span>");c&&(b+='<span class="button" onclick="jumpToForumPage('+(currentPage+1)+')">\u4e0b\u4e00\u9875</span>',b+='<span class="button" onclick="jumpToForumPage('+totalPages+')">\u5c3e\u9875</span>');$("#pager").html(b);$("#threadsnum").html("\u5171"+totalPages+"\u9875 \u5171\u6709\u4e3b\u9898\u6570:"+totalThreads)}
function jumpToForumPage(b){$.getJSON("api/getforum.php?lid="+lid+"&page="+b,function(){totalThreads=metadata.total;threadsPerPage=metadata.threadsPerPage;currentPage=b;showForum(data);$("#threadlist").ScrollTo()})}function refreshForum(){loadForumPage(currentPage)}function deleteForumThread(b){confirm("\u786e\u5b9a\u5220\u9664\u5e16\u5b50\uff1f\uff08ID:"+b+"\uff09")&&apiGet("api/thread.handler.php?act=delete&tid="+b,function(){refreshForum()})};(function(b){"function"===typeof define&&define.amd&&define.amd.jQuery?define(["jquery"],b):b(jQuery)})(function(b){function a(a){return a}function d(a){return decodeURIComponent(a.replace(g," "))}function c(a){0===a.indexOf('"')&&(a=a.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));return f.json?JSON.parse(a):a}var g=/\+/g,f=b.cookie=function(e,h,g){if(void 0!==h){g=b.extend({},f.defaults,g);if("number"===typeof g.expires){var j=g.expires,l=g.expires=new Date;l.setDate(l.getDate()+j)}h=f.json?
...
c.scroll(b,a);return this}};d.fn.ScrollTo=d.ScrollTo.fn})(window);function loadLessonPage(b){apiGet("api/thread.handler.php?act=get&lid="+lid+"&page="+b,function(a,d){totalThreads=d.total;threadsPerPage=d.threadsPerPage;currentPage=b;showLessonForum(a)})}
...
function jumpToLessonPage(b){apiGet("api/thread.handler.php?act=get&lid="+lid+"&page="+b,function(a,d){totalThreads=d.total;threadsPerPage=d.threadsPerPage;currentPage=b;$("#threadlist").ScrollTo()})}function refreshLessonForum(){loadLessonPage(currentPage)}
function newThread(){var b=$("#newthread_subject").val(),a=$("#newthread_content").val();""==b.length?alert("\u6807\u9898\u4e3a\u7a7a"):80<b.length?alert("\u6807\u9898\u8fc7\u957f\uff01"):""==a.length?alert("\u5185\u5bb9\u4e3a\u7a7a"):1024<a.length?alert("\u5185\u5bb9\u8fc7\u957f\uff01"):($("#submit_button").html("\u63d0\u4ea4\u4e2d..."),$("#submit_button").attr("disabled",!0),apiPost("api/thread.handler.php?act=new",{s:b,c:a,l:lid},function(a){window.location.href="thread.php?tid="+a},function(){$("#submit_button").html("\u63d0\u4ea4");
$("#submit_button").attr("disabled",!1)}))}function deleteLessonThread(b){confirm("\u786e\u5b9a\u5220\u9664\u5e16\u5b50\uff1f\uff08ID:"+b+"\uff09")&&apiGet("api/thread.handler.php?act=delete&tid="+b,function(){refreshLessonForum()})}
...
function loadLessonmates(){apiGet("api/getlessonmates.php?lid="+lid+"&page="+lessonmatePage,function(b,a){lessonmatesPerPage=a.lessonmatesPerPage;showLessonmates(b)})}
...
$("#lessonmatelist").html(a):1<lessonmatePage&&$("#lessonmatelist").append(a)}function loadMoreLessonmates(){lessonmatePage++;loadLessonmates()};function loadMessage(){apiGet("api/notice.handler.php?act=getmessage&page="+messagePage,function(b,a){messagesPerPage=a.messagesPerPage;showMessage(b)})}
...
c.from_uxh+'">'+c.uname+"</a><br />"+c.post_time+"</div>"),a=g?a+('<div class="title fl" onclick=""><a target="_blank"href="thread.php?tid='+c.tid+"&pid="+c.pid+'">\u6211\u56de\u590d\u4e86\u4f60\u7684\u5e16\u5b50\u201c'+c.subject+"\u201d\uff0c\u5feb\u53bb\u770b\u770b\u5427</a></div>"):a+('<div class="titlebold fl"><a target="_blank"href="thread.php?tid='+c.tid+"&pid="+c.pid+'">\u6211\u56de\u590d\u4e86\u4f60\u7684\u5e16\u5b50\u201c'+c.subject+"\u201d\uff0c\u5feb\u53bb\u770b\u770b\u5427</a></div>"),
a=a+'<div class="clear"></div>',a=a+"</div>";b.length==noticesPerPage?$("#pager").html('<span class="button" onclick="loadMoreNotice();">\u52a0\u8f7d\u66f4\u591a</span>'):$("#pager").html("");1==noticePage?$("#noticelist").html(a):1<noticePage&&$("#noticelist").append(a)}function loadMoreNotice(){noticePage++;loadNotice()};function setSignature(){var b=$("#signature").val();255<b.length?alert("\u7b7e\u540d\u8fc7\u957f\uff08\u5927\u4e8e255\u4e2a\u5b57\u7b26\uff09\uff01"):apiPost("api/user.handler.php?act=setsignature",{s:b},function(){alert("\u8bbe\u7f6e\u6210\u529f\uff01")})}
function uploadAvatar(){var b=$("#avatar_file").val();if(!b)return!1;b=b.split(".");if(1>=b.length)return alert("\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u6587\u4ef6\u540d"),!1;if(!{jpg:1,jpeg:1,gif:1,png:1}[b[b.length-1].toLowerCase()])return alert("\u62b1\u6b49\uff0c\u76ee\u524d\u4ec5\u652f\u6301\u683c\u5f0f\u4e3ajpg\u3001jpeg\u3001gif\u3001png\u7684\u56fe\u7247"),!1;$.ajaxFileUpload({url:"api/uploadavatar.php",secureuri:!1,fileElementId:"avatar_file",dataType:"json",success:function(a){1==a.code?alert(a.msg):
0==a.code&&alert("\u4e0a\u4f20\u6210\u529f!")}})};function checkRegisterForm(){var b=document.getElementById("register_form"),a=b.xh.value,d=b.password.value,b=b.confirm_password.value;isNaN(a)||9!=a.length?alert("\u8bf7\u68c0\u67e5\u8f93\u5165\u7684\u5b66\u53f7\u662f\u5426\u6709\u8bef"):6>d.length?alert("\u5bc6\u7801\u8fc7\u77ed\uff01\uff08\u5c11\u4e8e6\u4e2a\u5b57\u7b26\uff09"):d!=b?alert("\u4e24\u6b21\u8f93\u5165\u7684\u5bc6\u7801\u4e0d\u4e00\u81f4\uff01"):($("#submit_button").html("\u63d0\u4ea4\u4e2d..."),$("#submit_button").attr("disabled",
!0),apiPost("api/user.handler.php?act=register",{x:a,p:d},function(a){$.cookie("ck",a);window.location.href="index.php"},function(){$("#submit_button").html("\u63d0\u4ea4");$("#submit_button").attr("disabled",!1)}))};function loadThreadPage(b,a){apiGet("api/post.handler.php?act=get&tid="+tid+"&page="+b,function(b,c){currentPage=c.currentPage;totalPosts=c.total;postsPerPage=c.postsPerPage;showThread(b);a="undefined"!==typeof a?a:!1;!1!=a&&scrollToPost(a)})}
function showThread(b){for(var a="",d=0;d<b.length;d++){var c=b[d],a=a+('<div class="post_wrap" id="pid'+c.pid+'">'),a=a+'<div class="post_author">',a=a+'<div class="post_author_icon">',a=a+('<a target="_blank" href="user.php?uxh='+c.uxh+'"><img src="'+getAvatarURL(c.uxh,"1"==c.has_avatar)+'" ></a>'),a=a+"</div>",a=a+'<div class="post_author_name">',a=a+('<a target="_blank" href="user.php?uxh='+c.uxh+'">'+c.uname+"</a>"),a=a+"</div>",a=a+"</div>",a=a+'<div class="post_content_main">',a=a+('<pre class="post_content_text">'+
c.content+"</pre>"),a=a+'<div class="post_content_info">';1<c.floor&&(a+='<span><a class="clickable" onclick="replyPost('+c.floor+');">\u56de\u590d</a></span>',is_admin&&(a+='<span class="admin"><a class="clickable" onclick="deletePost('+c.pid+');">\u5220\u9664</a></span>'));"1"==c.from_client&&(a+='<span>\u6765\u81ea<a target="_blank" href="android.php">Android\u7248</a></span>');a+="<span>"+c.floor+"\u697c</span>";a+="<span>"+c.post_time+"</span>";a+="</div>";a+="</div>";a+='<div class="clear"></div>';
a+="</div>"}$("#postlist").html(a);totalPages=Math.floor((totalPosts-1)/postsPerPage+1);b="";d=1;a=totalPages;c=!1;5<currentPage&&(b=b+'<span class="button" onclick="jumpToThreadPage(1)">\u9996\u9875</span>'+('<span class="button" onclick="jumpToThreadPage('+(currentPage-1)+')">\u4e0a\u4e00\u9875</span>'),d=currentPage-4);9<a-d&&(c=!0,a=d+9);for(;d<=a;d++)b=d!=currentPage?b+('<span class="button" onclick="jumpToThreadPage('+d+')">'+d+"</span>"):b+('<span class="normal" >'+d+"</span>");c&&(b+='<span class="button" onclick="jumpToThreadPage('+
(currentPage+1)+')">\u4e0b\u4e00\u9875</span>',b+='<span class="button" onclick="jumpToThreadPage('+totalPages+')">\u5c3e\u9875</span>');$("#pager").html(b);$("#postsnum").html("\u5171"+totalPages+"\u9875 \u56de\u590d\u5e16:"+(totalPosts-1))}function jumpToThreadPage(b){apiGet("api/post.handler.php?act=get&tid="+tid+"&page="+b,function(a,b){currentPage=b.currentPage;totalPosts=b.total;postsPerPage=b.postsPerPage;showThread(a);$("#postlist").ScrollTo()})}
function refreshThread(){loadThreadPage(currentPage)}
function newPost(){var b=$("#newpost_content").val();""==b.length?alert("\u5185\u5bb9\u4e3a\u7a7a"):1024<b.length?alert("\u5185\u5bb9\u8fc7\u957f\uff01"):($("#submit_button").html("\u63d0\u4ea4\u4e2d..."),$("#submit_button").attr("disabled",!0),apiPost("api/post.handler.php?act=new",{c:b,t:tid},function(a){$("#newpost_content").val("");window.location.href="thread.php?tid="+tid+"&pid="+a},function(){$("#submit_button").html("\u63d0\u4ea4");$("#submit_button").attr("disabled",!1)}))}
function scrollToPost(b){$("#pid"+b).ScrollTo()}function deletePost(b){confirm("\u786e\u5b9a\u5220\u9664\u56de\u590d\u5e16\uff1f")&&apiGet("api/post.handler.php?act=delete&pid="+b,function(){refreshThread()})}function replyPost(b){$("#newpost_content").val("\u56de\u590d"+b+"\u697c: ");$("#newpost_content").ScrollTo();$("#newpost_content").focus()}function setThreadTop(b){apiGet("api/thread.handler.php?act=settop&tid="+tid+"&value="+b,function(){alert("done!")})};function loadTimetable(){showLoading();apiGet("api/getlessons.php?xh="+xh,function(b,a){xm=a.xm;showTimetable(b)})}function showLoading(){$("#loading_timetable").html("\u6b63\u5728\u8f7d\u5165\u8bfe\u7a0b...");$("#loading_timetable").css("display","block");$("#timetable").css("display","none")}function hideLoading(){$("#timetable").css("display","block");$("#loading_timetable").css("display","none")}var weekNames="\u661f\u671f\u4e00 \u661f\u671f\u4e8c \u661f\u671f\u4e09 \u661f\u671f\u56db \u661f\u671f\u4e94 \u661f\u671f\u516d \u661f\u671f\u65e5".split(" ");
function showTimetable(b){if(null==b)$("#loading_timetable").html("\u83b7\u53d6\u8bfe\u8868\u5931\u8d25...");else{for(var a="<tr>",d=0;7>d;d++)a+="<th>",a+=weekNames[d],a+="</th>";for(var a=a+"</tr>",c="<tr>",g=0;5>g;g++){for(d=0;7>d;d++){c+="<td>";if("undefined"!=typeof b[d]&&"undefined"!=typeof b[d][g]){var f=b[d][g],c=c+('<div title="\u70b9\u51fb\u8fdb\u5165\u8bfe\u7a0b\u8ba8\u8bba" class="lessongrid" onclick="openLessonForum(\''+f.lid+"');\">"),c=c+('<div class="lessonname">'+f.lessonname);1==
f.hasnew&&(c+='<span class="hasnew">New</span>');c+="</div>";c+='<div class="teachername">'+f.teachername+"</div>";c+='<div class="place">'+f.place+"</div>";c+="</div>"}c+="</div></td>"}c+="</tr>"}$("#timetable_name").html(xm+"\u7684\u8bfe\u8868");$("#timetable").html(a+c);hideLoading()}}function refreshTimetable(){xh=$("#xh").val();loadTimetable(xh)}function openLessonForum(b){window.location.href="lesson.php?lid="+b};
