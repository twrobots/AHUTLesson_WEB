...
b+='<span class="button" onclick="jumpToThreadPage('+totalPages+')">\u5c3e\u9875</span>');$("#pager").html(b);$("#postsnum").html("\u5171"+totalPages+"\u9875 \u56de\u590d\u5e16:"+(totalPosts-1))}function jumpToThreadPage(b){$.getJSON("api/post.handler.php?act=get&tid="+tid+"&page="+b,function(a){totalPosts=a[0];currentPage=b;showThread(a[1]);$("#postlist").ScrollTo()})}function refreshThread(){loadPage(currentPage)}
